	...
	return (
		<label className="relative inline-block text-17px w-16 h-[34px]">
			{themeCtx?.theme === "light" && (
				<span className="sun">
					<svg
						className="absolute top-[6px] left-9 z-1 h-6"
			...
			{themeCtx?.theme === "dark" && (
				<span className="moon">
					<svg
						className="fill-[#73c0fc] absolute top-[5px] left-[5px] z-1 w-6 h-6"
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 384 512"
					>
			...
			<span className="absolute cursor-pointer top-0 right-0 left-0 bottom-0 bg-[#49abf7] transition duration-300 rounded-[30px] dark:bg-[#285594]">
				<svg
					className="absolute h-[30px] w-[30px] rounded-[20px] left-[2px] bottom-[2px] z-2 duration-300 dark:translate-x-[30px]"
					viewBox="0 0 512 512"
					xmlns="http://www.w3.org/2000/svg"
				>
					<path
