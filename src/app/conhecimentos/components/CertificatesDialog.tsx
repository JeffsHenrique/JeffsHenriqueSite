...
const CertificatesDialog: FC<CertificatesDialogProps> = ({ open, onClose }) => {
	const [
		...
		setShouldFreeCoursesCertificatesShow,
	] = useState<boolean>(true);
	const [
		shouldSpecializationCoursesCertificatesShow,
		setShouldSpecializationCoursesCertificatesShow,
							...
							<li>
								...
								{shouldFreeCoursesCertificatesShow && (
									<ul className="ml-16 my-2 flex flex-col gap-4 list-disc">
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://app.rocketseat.com.br/certificates/03269e8d-8f32-49c8-b358-608668544a38"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://app.rocketseat.com.br/certificates/4192bf0f-df1c-48c4-80de-2d9c234df2df"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.udemy.com/certificate/UC-1e117c5b-5d28-4625-9823-8d249e2cfbb8/"
												target="_blank"
											>
												React JS: Aprenda ReactJS do zero com projetos práticos
												(Udemy)
											</Link>
										</li>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.udemy.com/certificate/UC-14d0fd21-3180-4a40-9e6f-2ca0f1b4defd/"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://alunos.b7web.com.br/media/certificates/certificado_655084.jpg"
												target="_blank"
											>
												Git/GitHub (B7Web)
											</Link>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://alunos.b7web.com.br/media/certificates/certificado_1283983.jpg"
												target="_blank"
											>
												Typescript (B7Web)
											</Link>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://alunos.b7web.com.br/media/certificates/certificado_3323489.jpg"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.cloudskillsboost.google/public_profiles/d0f4633d-e83c-4705-b932-bf445ef4df34/badges/14509369?locale=en&utm_medium=social&utm_source=linkedin&utm_campaign=ql-social-share"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.credly.com/badges/b2c6da2e-c8a3-4154-b195-21be8f4c4dc4/linked_in_profile"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.cloudskillsboost.google/public_profiles/d0f4633d-e83c-4705-b932-bf445ef4df34/badges/14388249?locale=en&utm_medium=social&utm_source=linkedin&utm_campaign=ql-social-share"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.cloudskillsboost.google/public_profiles/d0f4633d-e83c-4705-b932-bf445ef4df34/badges/14387089?locale=en&utm_medium=social&utm_source=linkedin&utm_campaign=ql-social-share"
												target="_blank"
											>
										...
										<li>
											<Link
												className="text-sky-700 dark:text-sky-500 underline"
												href="https://www.cloudskillsboost.google/public_profiles/d0f4633d-e83c-4705-b932-bf445ef4df34/badges/14360197?locale=en&utm_medium=social&utm_source=linkedin&utm_campaign=ql-social-share"
												target="_blank"
											>
